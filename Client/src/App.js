      ...
      <>
        <main>
          <Helmet>
            ...
            <meta
              name="description"
              content="The place to get your work done"
            />
          </Helmet>
            ...
            >
              ...
              <SwiperSlide className="slide">
                ...
                >
                  ...
                  <img
                    loading="lazy"
                    src="https://ik.imagekit.io/bhanu1776/Freelansters/s3.jpg?updatedAt=1682608750315"
                    alt="Top Jobs"
                  />
                </div>
              </SwiperSlide>
              ...
              <SwiperSlide className="slide">
                ...
                >
                  ...
                  <img
                    loading="lazy"
                    src="https://ik.imagekit.io/bhanu1776/Freelansters/s1.jpg?updatedAt=1682608749586"
                    alt="Top Jobs"
                  />
                </div>
                <div className="title1" data-swiper-parallax="-300">
                  <h1 className="swiper-h1">Welcome, {username} </h1> <br />
                  <h2 className="swiper-h2">
                    {show
                      ? "Happy to see you back"
                      : "The place to get your work done"}
                  </h2>
                </div>
              </SwiperSlide>
              ...
              <SwiperSlide className="slide">
                ...
                >
                  ...
                  <img
                    loading="lazy"
                    src="https://ik.imagekit.io/bhanu1776/Freelansters/s2.jpg?updatedAt=1682608749911"
                    alt="Top Jobs"
                  />
                </div>
              ...
              <SwiperSlide className="slide">
                ...
                >
                  ...
                  <img
                    loading="lazy"
                    src="https://ik.imagekit.io/bhanu1776/Freelansters/s4.jpg?updatedAt=1682608750273"
                    alt="Top Jobs"
                  />
                </div>
        ...
        <section id="Website-des">
          ...
          <div className="glass">
            ...
            >
              <p id="feat-p">
                Working for yourself has several advantages, whether you do it
                by founding your own company or by accepting numerous
                assignments as a freelancer. Flexibility, freedom of choice in
                projects and clients, and financial potential are all benefits
                of working as freelancer. Many people in a variety of
                professions like to be their own boss, and freelancing is the
            ...
            <img
              ...
              data-aos-easing="ease-out"
              id="g-img"
              src="https://ik.imagekit.io/bhanu1776/Freelansters/glass-right.png?updatedAt=1682608753541"
              alt="Freelanster"
            />
          </div>
        </section>
        ...
        <article id="Features-arc">
          ...
          >
            <div>
              <h3>Post a Job</h3>
              <p>
                A job posting is defined as an official advertisement created by
                the employer, human resources, or a recruiter to alert existing
                employees or job seekers regarding a job opening within the
                company.{" "}
              </p>
              <h3>Choose Freelancers</h3>
              <p>
                No job is too big or too small. We've got freelancers for job of
                any size or budget with extra-ordinary skill. <br />{" "}
                <b> No job is complex. We can get it done!</b>
              </p>
              <h3>Pay Securely</h3>
              <p>
                One pay for work when it has been completed and you're 100%
                statisfied with the quality using our milestone payment system.
              </p>
              <h3>We're here to help</h3>
              <p>
                Our talented team of recruiter can help you find the best
